...
def cfg():
    ...
    activation_fn_type = 'dumbbell' # For the possible choices, see the activation.py file
    ...
    L=dumbbell_dist+activation_circle_radius
    #window_velocity = 0
    #n_part = 20000
    n_part = 5000
    particle_density = n_part / ((2*L)**2) 

    ## Interaction parameters
    # Particle properties
    m_init=1.
    activation_decay_rate = 0
    # Spring properties
    spring_cutoff = 4
    spring_lower_cutoff = 0.005
    spring_k=1.
    spring_r0=0.
    # LJ properties
    LJ_eps=0.
...
def main(_config, _run):
    ...
    ## Setup Folders
    uid = uuid4()
    data_dir = f'/tmp/boxspring-{run_id}-{uid}'
